...
for i, line in enumerate(lines):
    if "List<GH_Curve> branch_geometries" in line:
        start_idx = i
    if "total_panels++;" in line and start_idx != -1 and end_idx == -1:
        # Find the end of the loop that contains this
...
if start_idx != -1 and end_idx != -1:
    new_lines = lines[:start_idx] + ["""            List<GH_Curve> branch_geometries = new List<GH_Curve>();
