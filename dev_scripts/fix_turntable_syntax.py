...
# Match the bad part from timer.Stop() to the end of the DA.SetData(4, "...")
pattern = re.compile(r'timer\.Stop\(\);.*?DA\.SetData\(4, "TURNTABLE CAMERA ENGINE\n"\s*\+\s*"\\n"', re.DOTALL)

replacement = r"""timer.Stop();
