...
namespace Enzyme.Utils
{
    ...
    {
                public static void WireIntegerSlider(GH_Component comp, GH_Document doc, int paramIndex, int min, int max, int val, int offsetX, int offsetY)
        {
        ...
        public static void WireBooleanToggle(GH_Component component, GH_Document doc, int paramIndex, bool defaultVal, int offsetX, int offsetY)
        {
        ...
        public static void WireHumanCurvePreviewToParam(Grasshopper.Kernel.IGH_Param param, GH_Document doc, System.Drawing.Color color, double thickness, int offsetX, int offsetY)
        {
