    ...
    public class ModBalconyComponent : GH_Component
    {
                ...
                public override void AddedToDocument(GH_Document document)
        {
            ...
            if (!hasSources)
            {
                ...
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 3, 0.0, 10.0, 1.5, ix, -120);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 4, 0.0, 10.0, 1.1, ix, -90);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 5, 0.0, 10.0, 0.0, ix, -60);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 6, 0.0, 10.0, 0.0, ix, -30);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 10, false, ix, 0);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 11, false, ix, 30);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 12, false, ix, 60);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 13, 0.0, 10.0, 0.0, ix, 90);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 14, false, ix, 120);
