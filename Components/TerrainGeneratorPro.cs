...
namespace Enzyme.Components
{
    ...
    public class TerrainGeneratorPro : GH_Component
    {
                ...
                public override void AddedToDocument(GH_Document document)
        {
            ...
            if (!hasSources)
            {
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 1, 0.0, 200, 100.0, 160, -240);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 2, 0.0, 2.0, 0.0, 160, -210);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 3, 0.0, 84, 42, 160, -180);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 6, 0.0, 2.0, 1.0, 160, -150);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 7, 0.0, 10.0, 5.0, 160, -120);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 9, 0.0, 200, 100, 160, -90);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 10, false, 80, -60);
                Enzyme.Utils.AutoWireHelper.WireColorSwatch(this, document, 11, System.Drawing.Color.DarkGray, 120, -30);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 12, 0.0, 60, 30.0, 160, 0);
                Enzyme.Utils.AutoWireHelper.WireValueList(this, document, 13, new string[]{"Realistic Soft Hills", "Ridged/Cellular Pattern"}, new string[]{"0", "1"}, 150, 30);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 14, false, 80, 60);
                Enzyme.Utils.AutoWireHelper.WireColorSwatch(this, document, 15, System.Drawing.Color.DimGray, 120, 90);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 16, 0.0, 2.0, 0.0, 160, 120);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 17, 0.0, 2.0, 0.0, 160, 150);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 18, 0.0, 24690, 12345, 160, 180);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 19, 0.0, 2.0, 0.15, 160, 210);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 20, 0.0, 2.0, 0.85, 160, 240);
                Enzyme.Utils.AutoWireHelper.WireCustomPreview(this, document, 0, System.Drawing.Color.FromArgb(230, 230, 230), 150, -60);
                Enzyme.Utils.AutoWireHelper.WireOutputParam(this, document, 1, "curve", 150, 0);
                Enzyme.Utils.AutoWireHelper.WireOutputParam(this, document, 2, "curve", 150, 30);
                Enzyme.Utils.AutoWireHelper.WireOutputParam(this, document, 3, "point", 150, 60);
            }
        }
