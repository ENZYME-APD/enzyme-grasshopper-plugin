...
namespace Enzyme.Components
{
    ...
    public class TerrainGeneratorPro : GH_Component
    {
                ...
                public override void AddedToDocument(GH_Document document)
        {
            ...
            {
                int ix = 220, ox = 250;
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 1, 0.0, 200.0, 100.0, ix, -150);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 2, 0.0, 10.0, 0.0, ix, -120);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 3, 0.0, 84, 42, ix, -90);
                Enzyme.Utils.AutoWireHelper.WirePanel(this, document, 4, "500.0\n100.0\n20.0", ix, -45, 120, 60);
                Enzyme.Utils.AutoWireHelper.WirePanel(this, document, 5, "1.0\n0.4\n0.05", ix, 25, 120, 60);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 6, 0.0, 10.0, 1.0, ix, 70);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 7, 0.0, 10.0, 5.0, ix, 100);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 9, 0.0, 200, 100, ix, 130);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 10, false, ix, 160);
                Enzyme.Utils.AutoWireHelper.WireColorSwatch(this, document, 11, System.Drawing.Color.DarkGray, ix, 190);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 12, 0.0, 60.0, 30.0, ix, 220);
                Enzyme.Utils.AutoWireHelper.WireValueList(this, document, 13, new string[]{"Realistic Soft Hills", "Ridged/Cellular Pattern"}, new string[]{"0", "1"}, ix, 250);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 14, false, ix, 280);
                Enzyme.Utils.AutoWireHelper.WireColorSwatch(this, document, 15, System.Drawing.Color.DimGray, ix, 310);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 16, 0.0, 10.0, 0.0, ix, 340);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 17, 0.0, 10.0, 0.0, ix, 370);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 18, 0.0, 24690, 12345, ix, 400);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 19, 0.0, 10.0, 0.15, ix, 430);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 20, 0.0, 10.0, 0.85, ix, 460);
                ...
                Enzyme.Utils.AutoWireHelper.WireOutputParam(this, document, 2, "curve", ox, -20);
