    ...
    public class ModRhythmBalcComponent : GH_Component
    {
                ...
                public override void AddedToDocument(GH_Document document)
        {
            ...
            if (!hasSources)
            {
                ...
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 4, 0.0, 3.0, 1.1, 160, -105);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 5, 0.0, 2.0, 0.0, 160, -75);
                Enzyme.Utils.AutoWireHelper.WirePanel(this, document, 6, "1", 120, -45, 80, 25);
                Enzyme.Utils.AutoWireHelper.WirePanel(this, document, 7, "0", 120, -15, 80, 25);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 8, false, 80, 15);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 9, false, 80, 45);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 10, false, 80, 75);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 11, false, 80, 105);
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 12, 0.0, 2.0, 0.0, 160, 135);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 13, false, 80, 165);
                Enzyme.Utils.AutoWireHelper.WireCustomPreview(this, document, 0, System.Drawing.Color.FromArgb(180, 180, 180), 150, -195);
                Enzyme.Utils.AutoWireHelper.WireCustomPreview(this, document, 1, System.Drawing.Color.FromArgb(150, 150, 150), 150, -135);
                Enzyme.Utils.AutoWireHelper.WireCustomPreview(this, document, 2, System.Drawing.Color.FromArgb(230, 230, 230), 150, -75);
                Enzyme.Utils.AutoWireHelper.WireCustomPreview(this, document, 3, System.Drawing.Color.FromArgb(150, 200, 255), 150, -15);
                Enzyme.Utils.AutoWireHelper.WireCustomPreview(this, document, 4, System.Drawing.Color.FromArgb(250, 250, 250), 150, 45);
                Enzyme.Utils.AutoWireHelper.WireCustomPreview(this, document, 5, System.Drawing.Color.FromArgb(250, 250, 250), 150, 105);
                Enzyme.Utils.AutoWireHelper.WireCustomPreview(this, document, 6, System.Drawing.Color.FromArgb(250, 250, 250), 150, 165);
            }
        }
