    ...
    public class ModRhythmBalcComponent : GH_Component
    {
                ...
                public override void AddedToDocument(GH_Document document)
        {
            ...
            if (!hasSources)
            {
                ...
                Enzyme.Utils.AutoWireHelper.WirePanel(this, document, 6, "1", ix, -30, 80, 25);
                Enzyme.Utils.AutoWireHelper.WirePanel(this, document, 7, "0", ix, 0, 80, 25);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 8, false, ix, 30);
                Enzyme.Utils.AutoWireHelper.WireToggle(this, document, 9, false, ix, 60);
                ...
                Enzyme.Utils.AutoWireHelper.WireSlider(this, document, 12, 0.0, 10.0, 0.0, ix, 150);
